...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/controller_ign_en.v"                                 -work ign_en                                                                            -cdslib ./cds_libs/ign_en.cds.lib                                                                           
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/controller_command_en.v"                             -work command_en                                                                        -cdslib ./cds_libs/command_en.cds.lib                                                                       
  ncvlog     "$QSYS_SIMDIR/submodules/controller_system_status.v"                          -work system_status                                                                     -cdslib ./cds_libs/system_status.cds.lib                                                                    
  ncvlog     "$QSYS_SIMDIR/submodules/controller_disp_en_brightness.v"                     -work disp_en_brightness                                                                -cdslib ./cds_libs/disp_en_brightness.cds.lib                                                               
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/controller_nios2_qsys_0.v"                           -work nios2_qsys_0                                                                      -cdslib ./cds_libs/nios2_qsys_0.cds.lib                                                                     
