...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/controller_mm_interconnect_0_rsp_xbar_demux_001.sv"  -work rsp_xbar_demux_001                                                               
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/controller_mm_interconnect_0_cmd_xbar_mux_001.sv"    -work cmd_xbar_mux_001                                                                 
