add wave -noupdate -divider {controller_nios2e: top-level ports}
...
add wave -noupdate -divider {controller_nios2e: common}
...
add wave -noupdate -divider {controller_nios2e: breaks}
