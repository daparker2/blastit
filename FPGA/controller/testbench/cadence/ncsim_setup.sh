...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_merlin_traffic_limiter.sv"                    -work limiter                                                                           -cdslib ./cds_libs/limiter.cds.lib                                                                          
  ncvlog -sv "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_merlin_reorder_memory.sv"                     -work limiter                                                                           -cdslib ./cds_libs/limiter.cds.lib                                                                          
  ncvlog -sv "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_avalon_sc_fifo.v"                             -work limiter                                                                           -cdslib ./cds_libs/limiter.cds.lib                                                                          
  ncvlog -sv "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_avalon_st_pipeline_base.v"                    -work limiter                                                                           -cdslib ./cds_libs/limiter.cds.lib                                                                          
  ...
  ncvlog     "$QSYS_SIMDIR/controller_tb/simulation/submodules/controller_disp_en.v"                                -work disp_en                                                                           -cdslib ./cds_libs/disp_en.cds.lib                                                                          
  ...
  ncvlog     "$QSYS_SIMDIR/controller_tb/simulation/submodules/controller_ign.v"                                    -work ign                                                                               -cdslib ./cds_libs/ign.cds.lib                                                                              
  ...
  ncvlog     "$QSYS_SIMDIR/controller_tb/simulation/submodules/controller_nios2_qsys_0.vo"                          -work nios2_qsys_0                                                                      -cdslib ./cds_libs/nios2_qsys_0.cds.lib                                                                     
  ...
  ncvlog     "$QSYS_SIMDIR/controller_tb/simulation/submodules/controller_nios2_qsys_0_mult_cell.v"                 -work nios2_qsys_0                                                                      -cdslib ./cds_libs/nios2_qsys_0.cds.lib                                                                     
  ...
  ncvlog -sv "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_conduit_bfm_0005.sv"                          -work controller_inst_boost_bfm                                                         -cdslib ./cds_libs/controller_inst_boost_bfm.cds.lib                                                        
  ncvlog -sv "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_conduit_bfm_0004.sv"                          -work controller_inst_disp_en_bfm                                                       -cdslib ./cds_libs/controller_inst_disp_en_bfm.cds.lib                                                      
  ncvlog -sv "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_conduit_bfm_0003.sv"                          -work controller_inst_command_rx_bfm                                                    -cdslib ./cds_libs/controller_inst_command_rx_bfm.cds.lib                                                   
  ncvlog -sv "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_conduit_bfm_0002.sv"                          -work controller_inst_ign_bfm                                                           -cdslib ./cds_libs/controller_inst_ign_bfm.cds.lib                                                          
