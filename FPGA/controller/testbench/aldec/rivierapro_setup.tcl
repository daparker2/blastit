...
# ACDS 13.1 162 win32 2018.07.10.21:10:07
...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_merlin_traffic_limiter.sv"                    -l altera_common_sv_packages -work limiter                                                                          
  vlog  "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_merlin_reorder_memory.sv"                     -l altera_common_sv_packages -work limiter                                                                          
  vlog  "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_avalon_sc_fifo.v"                             -l altera_common_sv_packages -work limiter                                                                          
  vlog  "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_avalon_st_pipeline_base.v"                    -l altera_common_sv_packages -work limiter                                                                          
  ...
  vlog  "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_conduit_bfm_0005.sv"                          -l altera_common_sv_packages -work controller_inst_boost_bfm                                                        
  vlog  "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_conduit_bfm_0004.sv"                          -l altera_common_sv_packages -work controller_inst_disp_en_bfm                                                      
  vlog  "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_conduit_bfm_0003.sv"                          -l altera_common_sv_packages -work controller_inst_command_rx_bfm                                                   
  vlog  "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_conduit_bfm_0002.sv"                          -l altera_common_sv_packages -work controller_inst_ign_bfm                                                          
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L altera_common_sv_packages -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_001 -L rsp_xbar_demux -L cmd_xbar_mux_001 -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L limiter -L id_router_003 -L id_router_001 -L id_router -L addr_router_001 -L addr_router -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent -L nios2_qsys_0_jtag_debug_module_translator -L nios2_qsys_0_instruction_master_translator -L rst_controller -L irq_mapper -L mm_interconnect_0 -L jtag_uart_0 -L boost -L disp_en -L command_rx -L command_tx -L ign -L iram -L sysid_c001 -L dram -L nios2_qsys_0 -L controller_inst_boost_bfm -L controller_inst_disp_en_bfm -L controller_inst_command_rx_bfm -L controller_inst_ign_bfm -L controller_inst_command_tx_bfm -L controller_inst_clk_bfm -L controller_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiii_ver $TOP_LEVEL_NAME
}
