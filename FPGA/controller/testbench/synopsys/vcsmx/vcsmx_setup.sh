...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k           "$QSYS_SIMDIR/controller_tb/simulation/submodules/controller_ign_en.v"                                 -work ign_en                                                                           
  ...
  vlogan +v2k           "$QSYS_SIMDIR/controller_tb/simulation/submodules/controller_command_en.v"                             -work command_en                                                                       
  vlogan +v2k           "$QSYS_SIMDIR/controller_tb/simulation/submodules/controller_system_status.v"                          -work system_status                                                                    
  vlogan +v2k           "$QSYS_SIMDIR/controller_tb/simulation/submodules/controller_disp_en_brightness.v"                     -work disp_en_brightness                                                               
  ...
  vlogan +v2k           "$QSYS_SIMDIR/controller_tb/simulation/submodules/controller_nios2_qsys_0.v"                           -work nios2_qsys_0                                                                     
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_conduit_bfm_0008.sv"                          -work controller_inst_ign_en_bfm                                                       
  vlogan +v2k -sverilog "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_conduit_bfm_0007.sv"                          -work controller_inst_boost_bfm                                                        
  vlogan +v2k -sverilog "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_conduit_bfm_0006.sv"                          -work controller_inst_warning_en_bfm                                                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_conduit_bfm_0005.sv"                          -work controller_inst_command_en_bfm                                                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_conduit_bfm_0004.sv"                          -work controller_inst_system_status_bfm                                                
  vlogan +v2k -sverilog "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_conduit_bfm_0003.sv"                          -work controller_inst_disp_en_brightness_bfm                                           
  vlogan +v2k -sverilog "$QSYS_SIMDIR/controller_tb/simulation/submodules/altera_conduit_bfm_0002.sv"                          -work controller_inst_command_rx_bfm                                                   
