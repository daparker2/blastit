...
alias com {
  ...
  vlog     "$QSYS_SIMDIR/controller_tb/simulation/submodules/controller_leds1_wr_val.v"                                                       -work leds1_wr_val                                                               
