...
// Clamshell back
CLAMSHELL_INNER_X=78;
CLAMSHELL_INNER_Y=86;
CLAMSHELL_INNER_Z=5;
CLAMSHELL_OUTER_X=90;
CLAMSHELL_OUTER_Y=96;
...
CLAMSHELL_VIEWPANE_SCALE_Z=4.5;
...
VIEWPANE_HOLE_OFFSET_X1=46;
VIEWPANE_HOLE_OFFSET_X2=46;
VIEWPANE_HOLE_OFFSET_Y1=49;
VIEWPANE_HOLE_OFFSET_Y2=-49;
VIEWPANE_HOLE_SCALE = 1.25;

// Clamshell front
CLAMSHELL_VIEWPANE_Z=3.5;

// Clamshell connector
CLAMSHELL_CONNECTOR_OUTER_X=85;
CLAMSHELL_CONNECTOR_OUTER_Y=15;
CLAMSHELL_CONNECTOR_OUTER_Z=15;
CLAMSHELL_CONNECTOR_INNER_X=75;
CLAMSHELL_CONNECTOR_INNER_Y=20;
CLAMSHELL_CONNECTOR_INNER_Z=15;
CLAMSHELL_CONNECTOR_INNER_OFFSET_Z=5;
CLAMSHELL_CONNECTOR_OFFSET_X=0;
CLAMSHELL_CONNECTOR_OFFSET_Y=-18;
CLAMSHELL_CONNECTOR_OFFSET_Z=-14;
...
CLAMSHELL_CONNECTOR_OUTER_HOLE_H=18;
				...
				difference() {
					...
					translate([0,0,CLAMSHELL_CONNECTOR_INNER_OFFSET_Z])
						minkowski() {
							...
							rotate([90,0,0])
							cylinder(r=CLAMSHELL_CONNECTOR_ROUND_W, h=CLAMSHELL_CONNECTOR_INNER_Y, $fn=FN_ROUND);
						}
